            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-10">
              <div className="flex items-center justify-between h-18 py-4">
                ...
                <div className="hidden md:flex items-center gap-8">
                  ...
                  <Link to="/ManageEvents"  className={`font-medium text-sm transition-colors ${linkColor}`}>Manage Events</Link>

                  <Link to="/managebooking"  className={`font-medium text-sm transition-colors ${linkColor}`}>Manage Booking</Link>
